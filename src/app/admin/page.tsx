      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <StatsCard
            ...
            value={stats.total}
            icon={
              <svg className="w-6 h-6 text-[#307cf1]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-900">Recente Inzendingen</h2>
            <a
              href="/admin/submissions"
              className="text-sm font-medium text-[#307cf1] hover:text-[#2563eb] transition-colors"
            >
              Bekijk alles
            </a>
          </div>
