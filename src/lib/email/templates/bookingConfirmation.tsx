                            ...
                            <tr>
                              <td style={{ padding: '12px 16px' }}>
                                <p style={{ fontSize: '12px', color: '#92400e', margin: 0, lineHeight: '1.5' }}>
                                  <strong>Tip:</strong> Voeg <em>notifications@ambitionvalley.nl</em> toe aan uw contacten zodat onze e-mails niet in uw spam terechtkomen. Controleer ook uw spam-map als u geen herinneringen ontvangt.
                                </p>
                              </td>
                            </tr>
                          </tbody>
